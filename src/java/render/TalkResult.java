...
public class TalkResult {
    public static String showTalkResult(Map<String, Object> request, Map<String, Object> service) {
        String result = "";
        try {
            ...
            for (Row talkresult : list) {
                fr.tr(table, talkresult.get("id"),getChangeForm(talkresult.get("id"),talkresult.get("name")),getDeleteForm(talkresult.get("id")));
            }
