...
public class Doctors {
    ...
    public static String showDoctors(Map<String, Object> request, Map<String, Object> service) {
        String result = "";
        try {
            ...
            for (Row doctors : list) {
                fr.tr(table, doctors.get("id"),getChangeForm(doctors.get("id"),doctors.get("name")),getDeleteForm(doctors.get("id")));
            }
