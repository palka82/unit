...
public class Treatment {
    ...
    public static String showTreatments(Map<String, Object> request, Map<String, Object> service) {
        String result = "";
        try {
            ...
            List<Row> list = (List<Row>) service.get("treatmentList");
            for (Row treatment : list) {
                fr.tr(table, treatment.get("treatment_id"),getChangeForm(treatment.get("treatment_id"),treatment.get("name")),getDeleteForm(treatment.get("treatment_id")));
            }
    ...
    private static AbsEnt getChangeForm(Object primaryId,Object currentName) throws Exception {
        ...
        inner.put(fr.hiddenInput("treatment_id", primaryId), "");
        AbsEnt se = fr.rightForm(inner, fo);
        return se;
    }
